...
import com.techversat.ledimanager.Monitors.WeatherData;
...
public class Idle {
	...
	public static void sendLcdIdle(Context context) {
		...
		Protocol.sendLcdBitmap(bitmap, LEDIService.WatchBuffers.IDLE);
	...
	public static boolean toIdle(Context context) {
		...
		LEDIService.WatchModes.IDLE = true;
		LEDIService.watchState = LEDIService.LEDIStates.IDLE;
	...
	public static void updateLcdIdle(Context context) {
		if (LEDIService.watchState == LEDIService.LEDIStates.IDLE)
			sendLcdIdle(context);
	}
